...
function toggleFaq(questionElement) {
    ...
    const icon = questionElement.querySelector('.faq-icon .accordion-icon');
    ...
    document.querySelectorAll('.faq-item').forEach(item => {
        if (item !== faqItem) {
            ...
            const itemIcon = item.querySelector('.faq-icon .accordion-icon');
...
document.addEventListener('DOMContentLoaded', function() {
    // Skip FAQ functionality on FAQ page (always open)
